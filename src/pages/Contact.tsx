...
const Contact = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Some features like journaling work offline, but the AI companion requires an internet connection to provide real-time responses."
    }
  ];
      ...
      <main className="pt-20 overflow-x-hidden">
        ...
        <section className="py-20 px-6 lg:px-8 bg-white">
          <div className="container mx-auto max-w-7xl">
            {/* Contact Section */}
            <section className="text-center py-10 space-y-4 mb-12">
              <h2 className="text-xl font-semibold text-gray-800">Want to connect with the team?</h2>
              ...
              <p className="text-gray-600">
                We typically respond within 24–48 hours. For B2B partnerships, please mention your organization name.
              </p>
            </section>
            ...
            {/* Quick Links */}
            <div className="p-6 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl text-white">
