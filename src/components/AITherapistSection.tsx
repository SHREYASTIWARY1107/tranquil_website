...
const AITherapistSection = () => {
  ...
  return (
    <section 
      id="ai-therapist" 
      className="py-16 sm:py-24 bg-gradient-to-br from-slate-50 to-indigo-50 relative overflow-hidden"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          >
            {/* Simple Phone Mockup */}
            <div className="mx-auto w-64 sm:w-80 h-[400px] sm:h-[500px] bg-white rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-slate-200 flex items-center justify-center">
